...
metadata2 <-
  read.csv(
    "/Users/administrator/Desktop/Matt_G_TP/Matt_G_SeattleSix_New_03032023/Masking_Regions/masked_regions/wholeGeome/WG_Tree/ggtree/metadata_NoReferences.csv",
    header = TRUE
  )
...
metadata_old <-
  read.csv(
    "/Users/administrator/Desktop/Matt_G_TP/Matt_G_SeattleSix_New_03032023/Masking_Regions/masked_regions/wholeGeome/WG_Tree/ggtree/metadata_old.csv",
    header = TRUE
  )
...
filtered_dataset_ss14_cluster_D <-
  filtered_dataset_ss14[!(filtered_dataset_ss14$V1 == "UW15939" |
                            filtered_dataset_ss14$V2 == "UW15939"),]
filtered_dataset_ss14_cluster_D <-
  filtered_dataset_ss14_cluster_D[!(
    filtered_dataset_ss14_cluster_D$V1 == "R2110091" |
      filtered_dataset_ss14_cluster_D$V2 == "R2110091"
  ),]
filtered_dataset_ss14_cluster_D <-
  filtered_dataset_ss14_cluster_D[!(
    filtered_dataset_ss14_cluster_D$V1 == "R2110052" |
      filtered_dataset_ss14_cluster_D$V2 == "R2110052"
  ),]
filtered_dataset_ss14_cluster_D <-
  filtered_dataset_ss14_cluster_D[!(
    filtered_dataset_ss14_cluster_D$V1 == "P2110052" |
      filtered_dataset_ss14_cluster_D$V2 == "P2110052"
  ),]
filtered_dataset_ss14_cluster_D <-
  filtered_dataset_ss14_cluster_D[!(
    filtered_dataset_ss14_cluster_D$V1 == "P2120120" |
      filtered_dataset_ss14_cluster_D$V2 == "P2120120"
  ),]
filtered_dataset_ss14_cluster_D <-
  filtered_dataset_ss14_cluster_D[!(
    filtered_dataset_ss14_cluster_D$V1 == "P2120116" |
      filtered_dataset_ss14_cluster_D$V2 == "P2120116"
  ),]
filtered_dataset_ss14_cluster_D <-
  filtered_dataset_ss14_cluster_D[!(
    filtered_dataset_ss14_cluster_D$V1 == "UW16057L" |
      filtered_dataset_ss14_cluster_D$V2 == "UW16057L"
  ),]

median_nicols_noOutlier <-
  median(filtered_dataset_ss14_cluster_D$V3)
average_nicols_withOutlier <-
  mean(filtered_dataset_ss14_cluster_D$V3)
